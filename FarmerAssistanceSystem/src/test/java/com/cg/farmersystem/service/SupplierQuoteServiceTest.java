...
//      quote.setProductName("wheat");
//      quote.setQuantity(80);
//      quote.setQuote_Price(2000);
//      quote.setProduct(null);
//
//  Mockito.when(supplierQuoteJpaRepository.findById(1).get()).thenReturn(quote);
//  quote.setQuote_Price(3000);
//  Mockito.when(supplierQuoteJpaRepository.save(quote)).thenReturn(quote);
//  System.out.println(quote.getQuote_Price());
//  assertThat(supplierQuoteService.updateQuote(quote)).isEqualTo(quote);
//  
//}
