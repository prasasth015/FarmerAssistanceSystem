...
public class SwaggerConfiguration {
	...
	private ApiInfo metadata() {
		return new ApiInfoBuilder().title("Farmer Assistance App").description("API reference guide for developers").termsOfServiceUrl("https://www.abccg.com/").contact("Batra, Yatin").version("1.0").build();	
	}
